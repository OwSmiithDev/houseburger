...
import { pedidoLembrado } from '@/pages/TrackOrder';

/**
 * Atalho para o pedido em andamento.
 *
 * O cliente fecha o app enquanto espera a comida — sem esta faixa, voltar ao
 * acompanhamento exigiria guardar o link. O token sai do armazenamento local e
 * some sozinho quando o pedido é entregue ou cancelado.
 */
export const PedidoEmAndamento = () => {
  const token = pedidoLembrado();
